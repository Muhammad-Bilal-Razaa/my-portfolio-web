...
<section className="text-gray-600 body-font">
  ...
  <h1 className='text-yellow-400 md:text-center p-4 md:pt-[155px] pb-8 md:text-[24px] lg:text-[26px] text-[17px] sm:text-[20px] sm: font-medium  '>
My Projects
  </h1>
       ...
       <Image
          ...
          <div className="p-6">
            ...
            <p className="leading-relaxed mb-3">
              I created this project using HTML and CSS.This project is responsive and user friendly.
            </p>
      ...
      <div className="p-4 md:w-1/3">
       ...
       <Image
          ...
          <div className="p-6">
            ...
            <p className="leading-relaxed mb-3">
              I created this project using HTML , CSS and TypeScript.
              This is a dynamic resume generator.
            </p>
            <div className="flex items-center flex-wrap ">
              <a className="text-yellow-500 inline-flex items-center md:mb-2 lg:mb-0">
                Learn More
