...
const Navbar = () => {
  ...
  <div className="container mx-auto flex flex-wrap p-1 flex-col sm:flex-row sm:justify-between ">
    ...
    <nav className="  md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center md:gap-4 gap-2 sm:gap-3">
      < Link href="/" className="  text-[10px] sm:text-[15px]  lg:text-[17px] md:mr-5  sm:mr-3 hover:text-yellow-400 hover:lg:text-[20px] hover:sm:text-[17px] hover:text-[12px]">Home</Link>
      < Link href="#Projects"className="  text-[10px] sm:text-[15px] lg:text-[17px] md:mr-5  sm:mr-3 hover:text-yellow-400  hover:lg:text-[20px] hover:sm:text-[17px] hover:text-[12px] ">Projects</Link>
      < Link href="#Contact"className=" text-[10px]  sm:text-[15px] lg:text-[17px] md:mr-5  sm:mr-3 hover:text-yellow-400  hover:lg:text-[20px] hover:sm:text-[17px] hover:text-[12px] "> Contact </Link>
      < Link href="#About"className=" text-[10px]  sm:text-[15px] lg:text-[17px] md:mr-5  sm:mr-3 hover:text-yellow-400  hover:lg:text-[20px] hover:sm:text-[17px] hover:text-[12px] ">About</Link>
