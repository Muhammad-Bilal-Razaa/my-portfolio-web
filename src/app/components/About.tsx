...
<h1 className='text-yellow-400 md:text-center p-4 sm:p-4 md:text-[24px] lg:text-[26px] text-[17px] sm:text-[20px] sm: font-medium  '>
  About Me 
</h1>
    </div>
    <div className="text-center mb-20">
      <h1  className="sm:text-2xl md:text-3xl text-xl font-medium   title-font text-yellow-400 mb-4">
        
        <p className='fade-in'>Muhammad Bilal Raza</p>
      </h1>
      <p className='leading-relaxed italic text-gray-300  text-[11px] sm:text-[15px] lg:text-[17px]'>
